...
pyplot.title('model loss - cnn5_'+xydict[xy],fontsize = 40)
...
pyplot.savefig('cnn5_'+xydict[xy] +'_history' + ".png",bbox_inches = 'tight', pad_inches = 0.4)

model.save('cnn5_'+xydict[xy] +'.h5')
print('model saved as cnn5_'+xydict[xy] +'.h5')
