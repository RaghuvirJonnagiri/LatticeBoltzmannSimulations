...
pyplot.title('model loss - cnn3_'+xydict[xy],fontsize = 40)
...
pyplot.savefig('cnn3_'+xydict[xy] +'_history' + ".png",bbox_inches = 'tight', pad_inches = 0.4)

model.save('cnn3_'+xydict[xy] +'.h5')
print('model saved as cnn3_'+xydict[xy] +'.h5')
