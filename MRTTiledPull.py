...
fin = fin - omega*(fin - feq) # to do collision step prior and prepare for pull scheme in gpu
...
#         
        u_past = u.copy()
        #cuda.memcpy_dtoh(fin[0],fin_g0);cuda.memcpy_dtoh(fin[2],fin_g2);cuda.memcpy_dtoh(fin[3],fin_g3);
        #cuda.memcpy_dtoh(fin[3],fin_g3);cuda.memcpy_dtoh(fin[4],fin_g4);cuda.memcpy_dtoh(fin[5],fin_g5);
        #cuda.memcpy_dtoh(fin[6],fin_g6);cuda.memcpy_dtoh(fin[7],fin_g7);cuda.memcpy_dtoh(fin[8],fin_g8);
