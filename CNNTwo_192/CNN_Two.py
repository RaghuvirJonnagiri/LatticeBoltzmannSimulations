...
layer1 = Convolution2D(64, (4, 4),strides=4, activation='relu')(main_input)
...
layer5a = Conv2DTranspose(512,(8, 8), activation='relu')(layer4)
layer5b = Conv2DTranspose(512,(8, 8), activation='relu')(layer4)
layer6a = Conv2DTranspose(256,(3, 3),strides=3, activation='relu')(layer5a)
layer6b = Conv2DTranspose(256,(3, 3),strides=3, activation='relu')(layer5b)
layer7a = Conv2DTranspose(128,(2, 2), strides=2, activation='relu')(layer6a)
layer7b = Conv2DTranspose(128,(2, 2), strides=2, activation='relu')(layer6b)
...
layer9a = Conv2DTranspose(1, (2, 2), strides=2, activation='relu')(layer8a)
layer9b = Conv2DTranspose(1, (2, 2), strides=2, activation='relu')(layer8b)
layer10a = concatenate([main_input, layer9a], axis=1)
layer10b = concatenate([main_input, layer9b], axis=1)
...
optim = optimizers.RMSprop(lr=0.0001, rho=0.9, epsilon=1e-08, decay=0.02)
...
pyplot.title('model loss - cnn2_'+xydict[xy],fontsize = 40)
...
pyplot.savefig('cnn2_'+xydict[xy] +'_history' + ".png",bbox_inches = 'tight', pad_inches = 0.4)

model.save('cnn2_'+xydict[xy] +'.h5')
print('model saved as cnn2_'+xydict[xy] +'.h5')
