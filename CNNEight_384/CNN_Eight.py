...
layer11a = concatenate([aux_input0, layer10a], axis=1)
layer11b = concatenate([aux_input1, layer10b], axis=1)
layer12a = (Convolution2D(50, (1, 1), activation='relu')(layer11a))
layer12b = (Convolution2D(50, (1, 1), activation='relu')(layer11b))
outputx = (Convolution2D(1,(1, 1), activation='relu' )(layer12a))
outputy = (Convolution2D(1,(1, 1), activation='relu' )(layer12b))
...
if xy == 0:
    model = Model(inputs=[main_input,aux_input0], outputs=outputxy[xy])
elif xy == 1:
    model = Model(inputs=[main_input,aux_input1], outputs=outputxy[xy])
