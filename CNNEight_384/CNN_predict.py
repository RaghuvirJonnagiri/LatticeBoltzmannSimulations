...
modelx = load_model('cnn8_x.h5')
print('MODELX SUMMARY: ')
print(modelx.summary())
print('------------------------------------------------------')
print('MODELY SUMMARY: ')
modely = load_model('cnn8_y.h5')
print(modely.summary())

velx = modelx.predict([fnet_test,velBCx_test])   
vely = modely.predict([fnet_test,velBCy_test])
...
pyplot.savefig('CNN8_predict' + "_Re" + str(int(round(Re_test))) + ".png",bbox_inches = 'tight', pad_inches = 0.4)
