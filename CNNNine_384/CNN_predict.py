...
print(modelx.summary())
print('------------------------------------------------------')
modely = load_model('cnn9_y.h5', compile=False) #compile option is added to get around a bug
...
pyplot.savefig('CNN9_predict' + "_Re" + str(int(round(Re_test))) + ".png",bbox_inches = 'tight', pad_inches = 0.4)
